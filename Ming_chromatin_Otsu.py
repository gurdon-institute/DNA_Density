...
colours = [Color(0.5,0.5,1.0), Color(1.0,0.5,0.0), Color(1.0,1.0,0.0)]
#colours = [ Color((t+1)/float(nLevels), (t+1)/float(nLevels), 1.0-(t+1)/float(nLevels)) for t in range(nLevels)] # scale for any nLevels
